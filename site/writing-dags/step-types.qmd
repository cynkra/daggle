...
The example above uses [`daggleR::daggle_output()`](https://cynkra.github.io/daggleR/reference/daggle_output.html) to emit a downstream value — see [Inter-Step Data Passing](data-passing.qmd) for the full pattern.
