...
### Summaries, metadata, and validations (daggleR 0.2.0) {#in-step-phase7}

The following in-step helpers will be available in daggleR 0.2.0. They emit the corresponding marker protocols documented in the [Output Protocol](../reference/output-protocol.qmd) reference.
...
### Artifacts, summaries, metadata, validations, and comparison (daggleR 0.2.0) {#api-phase7}

The following API wrappers will be available in daggleR 0.2.0.
