...
> **Function reference:** [cynkra.github.io/daggleR/reference](https://cynkra.github.io/daggleR/reference/) — every exported helper, with arguments and examples.

Install with:

```r
pak::pkg_install("cynkra/daggleR")
```
