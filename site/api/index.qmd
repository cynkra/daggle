...
The API is designed to be wrapped -- build custom dashboards with [daggleR](https://cynkra.github.io/daggler/) + Shiny, or any HTTP client.
...
- [daggleR API wrappers](https://cynkra.github.io/daggler/reference/index.html) -- call the API from R
